...
/**
 * Buscar en una lista de URLs permitidos para utilizar como API. Esto permite federar la
 *  utilización de FirmaEC sobre otra infraestructura, consultando en una lista
